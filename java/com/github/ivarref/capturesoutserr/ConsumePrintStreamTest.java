...
public class ConsumePrintStreamTest {

    public static final PrintStream stdOutOriginal = System.out;

    public static void main(final String[] ignoredArgs) {
        try (final PrintStream newStdOut = new ConsumePrintStream(ConsumePrintStreamTest::logToFile)) {
            System.out.println("Starting ConsumePrintStreamTest");
